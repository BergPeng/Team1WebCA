...
public class CompleteCard implements Serializable{
    ...
    public CompleteCard() {
        ...
        card = new Card("y101", "c1_10.png", "back.png", "yellow", "sk", 20); CardList.put("y101", card);
        card = new Card("y102", "c1_10.png", "back.png", "yellow", "sk", 20); CardList.put("y102", card);
        ...
        card = new Card("b012", "c3_01.png", "back.png", "blue", "nt", 1); CardList.put("b012", card);
        card = new Card("b021", "c3_02.png", "back.png", "blue", "nt", 2); CardList.put("b021", card);
        card = new Card("b022", "c3_02.png", "back.png", "blue", "nt", 2); CardList.put("b022", card);
        card = new Card("b031", "c3_03.png", "back.png", "blue", "nt", 3); CardList.put("b031", card);
        card = new Card("b032", "c3_03.png", "back.png", "blue", "nt", 3); CardList.put("b032", card);
        card = new Card("b041", "c3_04.png", "back.png", "blue", "nt", 4); CardList.put("b041", card);
        card = new Card("b042", "c3_04.png", "back.png", "blue", "nt", 4); CardList.put("b042", card);
        card = new Card("b051", "c3_05.png", "back.png", "blue", "nt", 5); CardList.put("b051", card);
        card = new Card("b052", "c3_05.png", "back.png", "blue", "nt", 5); CardList.put("b052", card);
        card = new Card("b061", "c3_06.png", "back.png", "blue", "nt", 6); CardList.put("b061", card);
        card = new Card("b062", "c3_06.png", "back.png", "blue", "nt", 6); CardList.put("b062", card);
        card = new Card("b071", "c3_07.png", "back.png", "blue", "nt", 7); CardList.put("b071", card);
        card = new Card("b072", "c3_07.png", "back.png", "blue", "nt", 7); CardList.put("b072", card);
        card = new Card("b081", "c3_08.png", "back.png", "blue", "nt", 8); CardList.put("b081", card);
        card = new Card("b082", "c3_08.png", "back.png", "blue", "nt", 8); CardList.put("b082", card);
        card = new Card("b091", "c3_09.png", "back.png", "blue", "nt", 9); CardList.put("b091", card);
        card = new Card("b092", "c3_09.png", "back.png", "blue", "nt", 9); CardList.put("b092", card);
        card = new Card("b101", "c3_10.png", "back.png", "blue", "sk", 20); CardList.put("b101", card);
        card = new Card("b102", "c3_10.png", "back.png", "blue", "sk", 20); CardList.put("b102", card);
        card = new Card("b111", "c3_11.png", "back.png", "blue", "rv", 20); CardList.put("b111", card);
        card = new Card("b112", "c3_11.png", "back.png", "blue", "rv", 20); CardList.put("b112", card);
        card = new Card("b121", "c3_12.png", "back.png", "blue", "p2", 20); CardList.put("b121", card);
        card = new Card("b122", "c3_12.png", "back.png", "blue", "p2", 20); CardList.put("b122", card);
        
        card = new Card("k131", "c4_00.png", "back.png", "black", "wl", 50); CardList.put("k131", card);
        card = new Card("k132", "c4_00.png", "back.png", "black", "wl", 50); CardList.put("k132", card);
        card = new Card("k133", "c4_00.png", "back.png", "black", "wl", 50); CardList.put("k133", card);
        card = new Card("k134", "c4_00.png", "back.png", "black", "wl", 50); CardList.put("k134", card);
       
        card = new Card("k141", "c4_01.png", "back.png", "black", "p4", 50); CardList.put("k141", card);
        card = new Card("k142", "c4_01.png", "back.png", "black", "p4", 50); CardList.put("k142", card);
        card = new Card("k143", "c4_01.png", "back.png", "black", "p4", 50); CardList.put("k143", card);
        card = new Card("k144", "c4_01.png", "back.png", "black", "p4", 50); CardList.put("k144", card);
    }
...
//    
//        
//    public String getColor(String cardId){
//        return CardList.get(cardId).getColor();
//    }
//    
//    public void setColor(String cardId,String color){
//        CardList.get(cardId).setColor(color);
//    }
}
